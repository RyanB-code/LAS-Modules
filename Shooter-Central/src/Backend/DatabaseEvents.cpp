...
Location::Location(const ShooterCentral::Location& setOld, const ShooterCentral::Location& setNew )
    :   old     { setOld },
        revised { setNew }
{
...
EventType::EventType(
        const ShooterCentral::ShootingEventType& setOld, 
        const ShooterCentral::ShootingEventType& setNew
    ):
        old     { setOld },
        revised { setNew }
{
...
WeaponType::WeaponType(
        const ShooterCentral::WeaponType& setOld, 
        const ShooterCentral::WeaponType& setNew
    ):
        old     { setOld },
        revised { setNew }
{
...
Cartridge::Cartridge(
        const ShooterCentral::Cartridge& setOld, 
        const ShooterCentral::Cartridge& setNew
    ):
        old     { setOld },
        revised { setNew }
{
